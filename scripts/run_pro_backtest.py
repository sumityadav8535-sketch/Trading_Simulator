...
print(f"signals={r.total_signals} trades={r.total_trades} wr={r.win_rate}% pf={r.profit_factor} ret={r.total_return_pct}%")
print("exits", r.exit_breakdown)
for t in r.trades:
    print(t.symbol, t.signal_date, t.pnl, t.exit_reason)